<x-layout>
    ...
    <div class="max-w-6xl mx-auto px-4 md:px-8 space-y-6">
        ...
        <a href="{{ route('noticias.index') }}"
            class="inline-flex items-center text-sm bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 shadow-sm rounded-lg py-2 px-3 font-semibold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 hover:bg-gray-100 hover:scale-105 transition">
