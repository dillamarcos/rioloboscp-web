    ...
    <div class="space-y-6 px-4 md:px-8">
        ...
        <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mb-6">
            ...
            <div class="w-full lg:w-auto">
                ...
                <button @click="$dispatch('open-create-partido')" class="btn-primary w-full lg:w-auto whitespace-nowrap">
                    ...
                    @forelse($partidos as $partido)
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition">
                            ...
                            <td class="px-4 py-3 min-w-[280px]">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex items-center gap-2 min-w-0">
                                        ...
                                        <img src="{{ $partido->equipoLocal->escudo ? asset('storage/'.$partido->equipoLocal->escudo) : asset('images/default-team.png') }}"
                                    ...
                                    <div class="flex items-center gap-2 min-w-0">
                                        ...
                                        <img src="{{ $partido->equipoVisitante->escudo ? asset('storage/'.$partido->equipoVisitante->escudo) : asset('images/default-team.png') }}"
                                            class="w-8 h-8 object-contain flex-shrink-0">
                            ...
                            <td class="px-4 py-3 text-right flex justify-end gap-1">
                                ...
                                <!-- EDITAR -->
                                <button @click='$dispatch("open-edit-partido", @json($data))'
